...
def process_control():
    ...
    # cfg['file_output'] = "Tables/MNIST_ConvRate_5clients_noniid_zeroinit"
    ...
    if cfg['data_name'] in ['MNIST']:
        ...
        cfg['lr'] = 1e-2
        cfg['lr_map'] = {1: 1e-2, 0.5: 1e-2, 0.25: 1e-2}
        cfg['momentum'] = 0.9
        cfg['weight_decay'] = 5e-4
        cfg['scheduler_name'] = 'MultiStepLR'
        cfg['factor'] = 0.1
        if cfg['data_split_mode'] == 'iid':
            cfg['num_epochs'] = {'global': 10, 'local':1}
            cfg['batch_size'] = {'train': 1, 'test': 50}
            cfg['milestones'] = [100]
        ...
        cfg['optimizer_name'] = 'SGD'
        cfg['lr'] = 1e-1
        cfg['lr_map'] = {1: 1e-1, 0.5: 5e-2, 0.25: 1e-2}
        cfg['momentum'] = 0.9
        cfg['weight_decay'] = 5e-4
        cfg['scheduler_name'] = 'MultiStepLR'
        cfg['factor'] = 0.1
